        ...
        <>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                    ...
                    >
                        Proposed Clause #{Number(changedClause) + 1} Change by{" "}
                        {proposer}
                        <Divider sx={{ m: 1 }} />
                        {proposedClauseText}
                    </Card>
            ...
            >
                <Stack spacing={2}>
                    ...
                    <Typography>
                        ...
                        perferendis quam aut nisi dignissimos ut ipsa harum sed
                        quos porro. 33 quia autem non illo nisi et sunt illo vel
                        molestiae obcaecati.
                    </Typography>
                    {clauseItems}
                </Stack>
